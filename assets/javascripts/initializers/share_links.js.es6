  ...
  initialize: function() {
    ...
    Sharing.addSource({
      ...
      generateUrl: function(link, title) {
        return ("http://service.weibo.com/share/share.php?url=" + encodeURIComponent(link) + "&title=分享了来自 @香蕉派开源硬件 的话题【" + encodeURIComponent(title))+ "】&searchPic=true&style=number";
      },
